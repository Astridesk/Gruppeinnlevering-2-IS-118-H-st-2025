...
if valg1 == "1":
    print("Erling går til HR for å finne en løsning til konflikten. HR foreslår et kompromiss mellom de to partenes ønsker, men Silje er ikke tilfreds med valget.")
    print("Dette resulterer i at motivasjonen hennes svekkes og hun presterer dårlig i arbeidet.")
    ...
    print("Erling tar individuelle samtaler med begge parter og får mer innsikt i Sivert og Siljes synspunkter. Erling kommer med råd, og Sivert og Silje blir enige etter Erlings oppfordring.")
...
if valg2 == "1":
    ...
    print("Erling bestemmer seg for å fokusere på teambygging, slik at teammedlemmene kan lære å kommunisere bedre og enklere ta hensyn til hverandres synspunkter.")
